...
export function ProjectsPage() {
  ...
  return (
    <PageTransition ariaLabel="Projects page">
      <SEO
        title="Projects"
        description="Projects spanning AI systems, data science, data engineering, fraud analytics, and statistical modeling."
        path="/projects"
      />

      <section className="section-spacing pt-0" aria-labelledby="featured-projects-heading">
        <SectionHeading
          id="featured-projects-heading"
          eyebrow="Featured Projects"
          level={1}
          title="Selected projects across AI systems, data science, and analytics."
          description="These projects cover LLM applications, evaluation workflows, streaming data platforms, fraud modeling, and statistical analysis."
        />
      ...
      <section className="section-spacing" aria-labelledby="all-projects-heading">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <SectionHeading
            ...
            eyebrow="Full Project Catalog"
            title="All public repositories."
            description="Browse the full catalog by category or search by problem area, tool, or method."
          />
        ...
        >
          <SectionHeading
            ...
            title="Browse the full project catalog."
            description="Search matches titles, summaries, highlights, and tech tags across the complete set of public repositories."
          />
            ...
            {filterChips.map((category) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'focus-ring inline-flex min-w-0 max-w-full flex-wrap items-center gap-2 rounded-full border px-4 py-2 text-left text-sm font-semibold uppercase tracking-[0.12em] transition',
                    isActive
